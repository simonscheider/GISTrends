...
pacman::p_load(readr,rvest,urltools,uuid,RSQLite,rjson,rgdal,curl,gtrendsR,
               dplyr,tmap,rmapshaper,ggplot2,reshape2,foreach,gtools)
...
# TODO: 
# - map of increase/decrease of interest for each GM every 5 years (within municip)
# - relative importance of areas: for each year a target (between municip)
