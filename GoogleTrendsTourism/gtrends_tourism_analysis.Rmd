...
FUN_subgroups(gtgmyear_df, c('year'), function(block){
  ...
  # palette_explorer()
  gtrends_map <- add_nl_basemap() + tm_shape(gm_gtrends_sdf) +
...
gt_countries_nonz = classIntervals(gt_countries_nonz$hits_asinh, 4, style = 'quantile')$brks
