...
bivariate.choropleth(fn, sdf, c('gt_sum_2017','tot_pop'),c('GTrends idx 2017','Population'), 'quantile')

fn = paste0(OUT_DIR,'gm_trend_map-between_gm-2017-pop_vs_gtrends-kmeans.pdf')
bivariate.choropleth(fn, sdf, c('gt_sum_2017','tot_pop'),c('GTrends idx 2017','Population'), 'kmeans')
